    ...
    for (int y = 0; y < donneedeniveau.length; y++) {
      ...
      for (int x = 0; x < ligne.length(); x++) {
        ...
        if (caractere == '#') {
          ...
          if (caractere == 'E' || caractere == 'e') {
            ennemi[compteurennemi] = new Ennemi(image_ennemiGvD, x*width/100, y*height/100);
            compteurennemi++;
          }
          if (longueurplateforme != 0) {
            obstacle[compteurplateforme] = new Obstacle((x - longueurplateforme)*width/100, y*height/100, longueurplateforme*10);
            compteurplateforme++;
      ...
      if (longueurplateforme != 0) {
        obstacle[compteurplateforme] = new Obstacle((ligne.length() - longueurplateforme)*width/100, y*height/100, longueurplateforme*10);
        compteurplateforme++;
        longueurplateforme = 0;
      }
    }
